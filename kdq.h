...
#define __KDQ_IMPL(type, SCOPE) \
	SCOPE kdq_##type##_t *kdq_init2_##type(int32_t bits) \
	{ \
		kdq_##type##_t *q; \
	...
	SCOPE kdq_##type##_t *kdq_init_##type(void) { return kdq_init2_##type( 2); } \
...
#define kdq_init2(type, bits) kdq_init2_##type( bits)
#define kdq_init(type, NULL) kdq_init_##type(NULL)
